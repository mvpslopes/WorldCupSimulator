          ...
          >
            {Object.keys(result.groups).map(groupLetter => (
              <motion.div
                ...
                className="bg-gray-800/90 rounded-lg p-4 shadow-xl border border-gray-700"
              >
                <h3 className="text-xl font-bold text-yellow-400 mb-3">Grupo {groupLetter}</h3>
              ...
              >
                <div className="flex items-center justify-between flex-wrap gap-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-xl font-semibold text-white">{match.team1.name}</span>
                  </div>
                  <span className="text-3xl font-bold text-yellow-400">
                    {match.score1} - {match.score2}
                  </span>
                  <div className="flex items-center space-x-3">
                    <span className="text-xl font-semibold text-white">{match.team2.name}</span>
                    <img 
